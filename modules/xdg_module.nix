...
in
{
  options.xdg.mime.predefined = {
    ...
    video = mkOption {
      inherit type;
      default = "smplayer.desktop";
    };
    audio = mkOption {
      inherit type;
      default = "com.github.neithern.g4music.desktop";
    };
    text = mkOption {
      inherit type;
    ...
    tg = mkOption {
      inherit type;
      default = "io.github.kukuruzka165.materialgram.desktop";
    };
    discord = mkOption {
      inherit type;
  ...
  config = {
    xdg.mime.defaultApplications = mkIf (cfg.enable) {
      ...
      "application/x-shellscript" = cfg.text;
