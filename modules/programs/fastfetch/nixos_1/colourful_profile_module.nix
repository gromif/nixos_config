...
let
  cfg = config.nixfiles.programs.fastfetch.colourful;
  isColourfulProfilesEnabled = cfg.enable;
  installPath = cfg.installPath;
  configName = "nixos_default";
  configText = ''
    {
        "logo": {
            "type": "kitty-direct",
        ...
        "display": {
            "separator": " ",
            "constants": [
                "\u001b[38;2;82;119;195m\u001B[1m",    // {$1},
                "\u001b[38;2;92;130;200m\u001B[1m",   // {$2},
                "\u001b[38;2;102;141;205m\u001B[1m",   // {$3},
                "\u001b[38;2;112;152;210m\u001B[1m",   // {$4},
                "\u001b[38;2;121;163;215m\u001B[1m",   // {$5},
                "\u001b[38;2;125;174;221m\u001B[1m",   // {$6},
                "\u001b[38;2;126;181;224m\u001B[1m",   // {$7},
                "\u001b[38;2;126;184;226m\u001B[1m",   // {$8},
                "\u001b[38;2;126;187;227m\u001B[1m",   // {$9},
                "\u001b[38;2;126;186;228m\u001B[1m",   // {$10},
                "┌───────────",   // {$11},
                "────────────",   // {$12},
                "───────────┐",   // {$13},
             ],
...
in
{
  config = mkIf isColourfulProfilesEnabled {
    environment.etc = {
      "${installPath}/${configName}.jsonc".text = configText;
    };
  };
}
